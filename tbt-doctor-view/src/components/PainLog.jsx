const PainLog = () => {
  ...
  return (
    ...
    >
      <div className="pain-log-title absolute left-[26px] top-[14px] w-[140px] h-[90px] text-[26px] font-normal leading-normal text-black" style={{ fontFamily: 'SF Pro, -apple-system, Roboto, Helvetica, sans-serif', fontWeight: 510 }}>
        View Patient 
        <div>Pain Log →</div>
      </div>
